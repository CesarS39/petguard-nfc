...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Únete a PetGuard y protege a tus mascotas
            </p>
          </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-green-600 via-emerald-700 to-teal-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          <h1 className="text-5xl font-bold mb-6 leading-tight">
            Únete a miles de dueños responsables
          </h1>
          <p className="text-xl text-green-100 mb-8 leading-relaxed">
            Crea tu cuenta y comienza a proteger a tus mascotas hoy mismo
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-2xl p-4">
              ...
              <div>
                <h3 className="font-semibold">Gratis para siempre</h3>
                <p className="text-sm text-green-100">Sin cargos ocultos ni suscripciones</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-2xl p-4">
              ...
              <div>
                ...
                <p className="text-sm text-green-100">Menos de 5 minutos para empezar</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-2xl p-4">
              ...
              <div>
                <h3 className="font-semibold">Totalmente seguro</h3>
                <p className="text-sm text-green-100">Tus datos están encriptados y protegidos</p>
              </div>
            </div>
          </div>
        </div>
