...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      {/* Sidebar Navigation */}
      <aside className={`fixed left-0 top-0 h-full w-72 bg-white border-r border-gray-200 z-50 transform transition-transform duration-300 ease-in-out ${
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-2">
              <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-green-600 rounded-xl flex items-center justify-center">
                <span className="text-2xl grayscale brightness-0 invert">🐾</span>
              </div>
        ...
        <main className="px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-6 sm:mb-8">
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6 hover:shadow-md transition-shadow">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2 sm:mb-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-0">
                  <span className="text-xl grayscale brightness-0 invert">🐾</span>
                </div>
              ...
              <h3 className="text-xs sm:text-sm font-medium text-gray-500 mb-1">Mascotas</h3>
              <p className="text-2xl sm:text-3xl font-bold text-gray-900">{petsCount}</p>
            </div>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6 hover:shadow-md transition-shadow">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2 sm:mb-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-0">
                  <span className="text-xl sm:text-2xl grayscale brightness-0 invert">✓</span>
                </div>
              ...
              <h3 className="text-xs sm:text-sm font-medium text-gray-500 mb-1">Chips</h3>
              <p className="text-2xl sm:text-3xl font-bold text-gray-900">{activePets}</p>
            </div>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xs sm:text-sm font-medium text-gray-500 mb-1">Espacios</h3>
              <p className="text-2xl sm:text-3xl font-bold text-gray-900">{availableSlots}</p>
            </div>
            ...
            >
              ...
              <h3 className="text-xs sm:text-sm font-medium text-gray-500 mb-1">Reportes</h3>
              <p className="text-2xl sm:text-3xl font-bold text-gray-900">{reportsCount}</p>
            </Link>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-600 to-green-600 rounded-xl sm:rounded-2xl shadow-lg p-6 sm:p-8 mb-6 sm:mb-8 text-white">
            <h2 className="text-xl sm:text-2xl font-bold mb-1 sm:mb-2">¿Listo para proteger otra mascota?</h2>
          ...
          <div id="pets" className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100">
            <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-100">
              <h2 className="text-lg sm:text-xl font-bold text-gray-900">Mis Mascotas</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 p-4 sm:p-6">
                {pets.map((pet) => (
                  ...
                  >
                    ...
                    <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-1 truncate">{pet.name}</h3>
